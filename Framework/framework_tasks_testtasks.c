...
int printRcTasktaskcount = 0;
int printMotorTasktaskcount = 0;
int controlMotorTaskTasktaskcount = 0;
int motorCanTransmitTasktaskcount = 0;
int printMPU6050Tasktaskcount = 0;
int readMPU6050Tasktaskcount = 0;
int printCtrlUartTasktaskcount = 0;
