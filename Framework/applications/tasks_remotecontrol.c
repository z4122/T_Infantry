/**
  ...
  * Description        : ÈÅ•ÊéßÂô®Â§ÑÁêÜ‰ªªÂä°
  ******************************************************************************
  *
...
static RemoteSwitch_t switch1;   //“£ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ‡≤¶ÔøΩÔøΩ

extern RampGen_t frictionRamp ;  //ƒ¶ÔøΩÔøΩÔøΩÔøΩ–±ÔøΩÔøΩ
extern RampGen_t LRSpeedRamp ;   //mouseÔøΩÔøΩÔøΩÔøΩÔøΩ∆∂ÔøΩ–±ÔøΩÔøΩ
extern RampGen_t FBSpeedRamp  ;   //mouse«∞ÔøΩÔøΩÔøΩ∆∂ÔøΩ–±ÔøΩÔøΩ
...
void MouseKeyControlProcess(Mouse *mouse, Key *key)
{
    ...
    if(GetWorkState()!=PREPARE_STATE)
    {
		...
		else
		{
			...
			FBSpeedRamp.ResetCounter(&FBSpeedRamp);//µ˜Ω⁄º±Õ£ª¨∂Ø
